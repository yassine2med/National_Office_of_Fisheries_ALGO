...
import AlerteAnalyseGroupeAccordions from '../accorditions/gestion-alertes/alertes-analysees/AlerteAnalyseGroupeAccordions';
...
const steps = [
  {label: 'Dossier 1er niveau' , component: <AlerteAnalyseGroupeAccordions/>},
...
export default function StepperAlerteAnalyse () {
    ...
    <div className={`${blur} border-0 rounded-lg shadow-lg mt-8 mx-10 mr-2 py-5 px-5 relative flex flex-col bg-white outline-none focus:outline-none`}>
      ...
      <Box sx={{ width: '100%' }}>
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={6} lg={4}>
                  <ButtonCustom variant="outlined" Externalstyle={{height:55}} borderColor="blue" textColor="blue"  text="Mettre à jour les tiers" />
                </Grid>
