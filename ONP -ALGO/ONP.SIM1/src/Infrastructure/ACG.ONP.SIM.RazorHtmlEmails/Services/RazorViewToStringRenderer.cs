...
{
    public class RazorViewToStringRenderer : ITemplateToStringRenderer
    {
        ...
        public async Task<string> RenderTemplateToStringAsync<TModel>(string templateName, TModel model)
        {
