...
import InvestigationAlerteGroupeAccordions from '../accorditions/gestion-alertes/investigation-alertes/InvestigationAlerteGroupeAccordions';
...
const steps = [
  {label: 'Dossier 1er niveau' , component: <InvestigationAlerteGroupeAccordions/>},
...
export default function StepperAlerteInvestigation() {
  ...
  return (
      ...
      <Box sx={{ width: '100%' }}>
            <div>
              <Stepper 
                ...
                size = {50}
                circleFontSize = {20}
                steps={ [{title: 'Dossier 1er niveau'}, {title: 'Préparation du dossier'}, {title: 'Décision 2ème niveau'}, {title: 'Déclaration Tracfin'}] } activeStep={ 1 } />
            </div>
    ...
    <InputAlert toggle={handleCloseClasserAlerte} isOpen={openClasserAlerte} text="Etes-vous sur(e)s de vouloir mettre l(es) alerte(s) en état erreur de saisie?" type='error'/>
</>
  );
}