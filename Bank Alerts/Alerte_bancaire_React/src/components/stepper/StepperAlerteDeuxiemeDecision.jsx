...
const steps = [
  {label: 'Dossier 1er niveau' , component: <AlerteDeuxiemeDecisionGroupeAccordions/>},
...
export default function StepperAlerteDeuxiemeDecision() {
      ...
      <Box sx={{ width: '100%' }}>
            <div>
              <Stepper 
                ...
                size = {50}
                circleFontSize = {20}
                steps={ [{title: 'Dossier 1er niveau'}, {title: 'Préparation du dossier'}, {title: 'Décision 2ème niveau'}, {title: 'Déclaration Tracfin'}] } activeStep={ 2 } />
            </div>
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={6} lg={4}>
                  <ButtonCustom variant="contained" Externalstyle={{height:55}} handleSubmit={() => InfoAlert("Etes-vous sûr(e) de vouloir passer l(es) alerte(s) en état ' A déclarer sur Tracfin ' ?")} color="danger" textColor="white" text="Déclarer alerte(s) à Tracfin" />
                </Grid>
                ...
                <Grid item xs={12} md={6} lg={4}>
                  <ButtonCustom variant="outlined" Externalstyle={{height:55}} borderColor="blue" textColor="blue" handleSubmit={() => InfoAlert("Etes-vous sur(e)s de vouloir mettre à jour les tiers ?")}   text="Mettre à jour les tiers" />
                </Grid>
