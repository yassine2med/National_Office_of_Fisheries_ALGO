...
import AlerteDeclarationTracfinGroupeAccordion from '../accorditions/gestion-alertes/attente-declaration-tracfin/AttenteDeclarationTracfinGroupeAccordion';
const steps = [
  {label: 'Dossier 1er niveau' , component: <AlerteDeclarationTracfinGroupeAccordion/>},
...
export default function StepperAttenteDeclarationTracfin() {
